        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (isIOS && !isStandalone) {
                const banner = `<div style="position:fixed;bottom:0;width:95%;background-color:#f8f8f8;border-top:1px solid #ddd;padding:10px;text-align:center;margin:0 1px 1px 1px;">
