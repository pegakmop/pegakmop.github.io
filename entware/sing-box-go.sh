...
sleep 5
echo
echo "⚠️По всем вопросам скрипта установщика пишем: https://t.me/pegakmop или в чате по ссылке: https://t.me/vpnconfiguration/62 так же пишите если вам нужен впн"
echo
