...
configure_wireguard() {
  ...
  ndmc -c "interface $iface_name wireguard peer bmXOC+F1FxEMF9dyiK2H5/1SUtzH0JuVo51h2wPfgyo= !WG"
...
if configure_wireguard; then
  ...
  echo "Для генерации нового конфига введи команду заново в терминале:   ./wg.sh"
else
