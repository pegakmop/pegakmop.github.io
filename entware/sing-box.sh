...
EOF
    ...
    while true; do
        ...
        echo "4) я позже решу этот вопрос"
    ...
    curl -L -s "https://raw.githubusercontent.com/pegakmop/hrneo/refs/heads/main/install.sh" > /tmp/install.sh && sh /tmp/install.sh
            ...
            3)
                ...
                ;;
            4)
                log "❌ Установка отменена, сами будете устанавливать кто будет управлять сингбоксом."
                break
                ;;
            *)
...
log "Дата обновления скрипта 2025.05.27 тестируем списки"
